    ...
    extends Service
{
    ...
    private final static Logger logger = Logger.getLogger(com.amazon.webservices.awsecommerceservice._2011_08_01.AWSECommerceService.class.getName());

    static {
        URL url = null;
        try {
            URL baseUrl;
            baseUrl = com.amazon.webservices.awsecommerceservice._2011_08_01.AWSECommerceService.class.getResource(".");
            url = new URL(baseUrl, "file:/Users/antoniombp/Documents/Code/Agoncal/agoncal-sample-jaxws/02-Amazon/src/wsdl/AWSECommerceService.wsdl");
        } catch (MalformedURLException e) {
            logger.warning("Failed to create URL for the wsdl Location: 'file:/Users/antoniombp/Documents/Code/Agoncal/agoncal-sample-jaxws/02-Amazon/src/wsdl/AWSECommerceService.wsdl', retrying as a local file");
